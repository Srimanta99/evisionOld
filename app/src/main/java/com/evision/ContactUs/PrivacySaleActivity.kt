...
class PrivacySaleActivity:AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolbar.setTitle(R.string.privayforsale)
        ...
        web_termcondition.loadUrl("https://www.evisionstore.com/termscondition.php?data=politica")
    }
