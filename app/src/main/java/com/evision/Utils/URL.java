...
public class URL {
   ...
   // public static final String TOKENVALIDATION="https://apisandboxqa.mpaycenter.com/api/oauth/token";
    ...
    public  static final String POPALERT="https://www.evisionstore.com/api/home/lockdown-popup.php";
    public  static final  String QUOTELIST="https://www.evisionstore.com/api/user/quote_list.php";
    public static final String PRODUCTDETAILs_MULTICOLOR="https://www.evisionstore.com/api/product/view-react.php";
    public static final String ADD_TO_CART_REACT="https://www.evisionstore.com/api/user/account/addtocart-react.php";
    public  static final  String SELECTATTRIBUTE="https://www.evisionstore.com/api/product/selectattribute-react.php";
